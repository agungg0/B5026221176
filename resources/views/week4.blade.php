...
<body>
    <div class="jumbotron-fluid border bg-primary text-center text-white">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 text-center mx-auto pt-5" >
                <img class="rounded align-middle" src="assetsWeek4/flower.jpg" width="80%" >
            </div>
        </div>
    </div>
</body>
